...
useEffect(()=>{
  ...
  return (
    <div className='sticky bg-gray-100/40 backdrop-blur-lg top-0 border-b'>
        <nav className='section h-[5rem] px-4 py-2 flex relative'>
            ...
            <ul className='hidden sm:flex ml-auto items-center gap-x-10 text-sm font-semibold text-gray-600 hover:text-black cursor-pointer'>
            ...
            <div className={`overflow-hidden sm:hidden transition-all duration-500 ${isMenuOpen ? 'h-[calc(100vh-5rem)]' : 'h-0'} bg-white absolute top-[5rem] left-0 w-full`}>
